...
[Snap releases](https://github.com/micruzz82/snap/releases) and `snap-telemetry` package.


### Snap CLI on top of REST API V2

The _alpha version_ of `snaptel` which relays on [Snap API Go client](https://github.com/micruzz82/snap-client-go) talking to [REST API V2](REST_API_V2.md) is available in a separate repo [snap-cli](https://github.com/micruzz82/snap-cli).

The separated Snap API client and CLI support [Swagger Open API Specification](https://swagger.io/specification). The Snap API client can be autogenerated based on provided [swagger.json](https://github.com/micruzz82/snap/swagger.json) in different languages/frameworks supported by [swagger-code-generator](https://github.com/swagger-api/swagger-codegen#swagger-code-generator) - to generate a new Snap API client in your preferred language, please follow the instruction provided there.
        
To get more help on the Snap API client and Snap CLI check out:
  - [snap-client-go](https://github.com/micruzz82/snap-client-go)
  - [snap-cli](https://github.com/micruzz82/snap-cli)
...
The documentation for the Snap CLI which bases on REST API V2 is located in [snap-cli](https://github.com/micruzz82/snap-cli).
